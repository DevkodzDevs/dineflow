...
export default async function SettingsPage() {
  ...
  const [{ data: tables }, { data: gw }] = await Promise.all([
  ...
  return (<><PageHeader eyebrow="Your restaurant" title="Settings" /><SettingsClient restaurant={session.restaurant as never} tables={tables ?? []} gateway={gateway} /></>);
}
